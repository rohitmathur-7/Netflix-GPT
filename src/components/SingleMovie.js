  ...
  return (
    <>
      ...
      <div className="movie-single">
        <div className="movie-container flex gap-8 bg-black text-white h-screen py-4 px-8">
          <div className="movie-poster flex items-center basis-[40%] overflow-hidden">
            <img
              alt="Movie Card"
          ...
          <div className="movie-content flex flex-col justify-center gap-8 basis-[60%]">
            <div>
